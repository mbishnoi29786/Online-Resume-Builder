...
<div class="cover " >
		...
		<div class="cvBody flex pull-left" >
			<div class="cv-head">
				<div class="photo center ">
					...
					<span style="color: white;" id="cvname">Your Name</span>
				</div>
				...
				<div class="about-tab fontTreb">
					...
					<div class="about-details">
						<ul>
							<li id="cvphone1">0123456789</li>
							<li id="cvphone2" style="display: none">0123456789</li>
							<li id="cvaddress">Your Address</li>
						</ul>
					</div>
				</div>
				<div class="about-tab fontTreb">
					...
					<div class="about-details" >
						<ul>
							<li id="cvskill1">Skill 1 </li>
							<li id="cvskill2" style="display: none;">Skill 2</li>
							<li id="cvskill3" style="display: none;">skill 3</li>
							<li id="cvskill4" style="display: none;">skill 4</li>
							<li id="cvskill5" style="display: none;">skill 5</li>
						</ul>
					</div>
				</div>
			...
			<div class="cv-content">
					...
					<div class="body-details fontTreb" id="cvExp1">
						<div class="detail-item">
							<div class="detail-item-head" id="cvExp1">
								<span id="cvExp1name">Training or any other Pratice</span>, 
								<span id="cvExp1start">20__</span>-
								<span id="cvExp1leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp1insiti">Institute or Company Name</div>
						</div>

						<div class="detail-item" style="display: none;" id="cvExp2">
							<div class="detail-item-head">
								<span id="cvExp2name">Training or any other Pratice</span>, 
								<span id="cvExp2start">20__</span>-
								<span id="cvExp2leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp2insiti">Institute or Company Name</div>
						</div>

						<div class="detail-item" style="display: none;" id="cvExp3">
							<div class="detail-item-head">
								<span id="cvExp3name">Training or any other Pratice</span>, 
								<span id="cvExp3start">20__</span>-
								<span id="cvExp3leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp3insiti">Institute or Company Name</div>
						</div>
						
						<div class="detail-item" style="display: none;" id="cvExp4">
							<div class="detail-item-head">
								<span id="cvExp4name">Training or any other Pratice</span>, 
								<span id="cvExp4start">20__</span>-
								<span id="cvExp4leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp4insiti">Institute or Company Name</div>
						</div>

						<div class="detail-item" style="display: none;" id="cvExp5">
							<div class="detail-item-head">
								<span id="cvExp5name">Training or any other Pratice</span>, 
								<span id="cvExp5start">20__</span>-
								<span id="cvExp5leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp5insiti">Institute or Company Name</div>
						</div>

						<div class="detail-item" style="display: none;" id="cvExp6">
							<div class="detail-item-head">
								<span id="cvExp6name">Training or any other Pratice</span>, 
								<span id="cvExp6start">20__</span>-
								<span id="cvExp6leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp6insiti">Institute or Company Name</div>
						</div>
					</div>
				</div>
				<br>
				...
				<div class="body-item" id="langMenu">
					...
					<div class="body-details fontTreb">
						<div class="detail-item">
							<div class="detail-item-text" id="cvLangText">Hindi,English and Sanskrit</div>
						</div>
	...
	<div class="well well-sm" style="width: 40%;margin-left: 8px;float: right;" >
		<ul class="nav nav-tabs">
		  <li ><a data-toggle="tab" href="#cvHeader">Resume Header</a></li>
		  <li class="active"><a data-toggle="tab" href="#menu-cvContent">Resume Content</a></li>
		  <li><a data-toggle="tab" href="#menu-pInfo">Personal Info</a></li>
		  <li><a data-toggle="tab" href="#menu-cvDesign">Resume Design</a></li>
		</ul>

		<div class="tab-content">
		  <div id="cvHeader" class="tab-pane fade  ">
		  	<div class="well well-sm">
		    <button class="pull-right btn btn-success" id="download">Finish and Download Resume</button>
		    <br><br>
		    ...
		    <div class="Well well-sm">
				...
				<div class="tab-content">
				  <div id="Exp1" class="tab-pane fade in active">
			    		...
			    		<button class="btn btn-primary btn-sm btn-block" id="hideExpBtn">Hide/Show Experience in Resume</button>
				  </div>
			...
			<div class="well well-sm">
				<table class="table table-striped table-hover">
			    	...
			    	<thread>
			    		<tr>
			    			<td colspan="2">
			    				<button class="btn btn-sm btn-primary btn-block" id="hidePersonalBtn">Hide/Show Personal Information Tab from Resume</button>
			    			</td>
			    		</tr>
			    	</thread>
			    </table>
		  ...
		  <div id="menu-cvDesign" class="tab-pane fade">
		    <div class="well well-sm">
		    	<table class="table table-striped table-hover">
		    		...
		    		<thread>
		    			<tr>
		    				<td style="width: 50%">Resume Body Background</td>
		    				<td><input type="color" name="" id="cvBodyBg" value="#FFFFFF" class="form-control input-sm"></td>
		    			</tr>
		    		</thread>
		    		<thread>
		    			<tr>
		    				<td style="width: 50%">Resume Body Text Color</td>
	...
	<div class="" style="width: 366px;padding: 22px;margin: auto;margin-top: 155px">
		<div class="panel panel-primary" style="box-shadow: 11px 11px 22px black">
			...
			<div class="panel-body">
				<button class="btn btn-block btn-success " id="saveCv"><i class="pull-left fa fa-save fa-fw"></i >Save Resume</button>
	...
	<div class="" style="width: 366px;padding: 22px;margin: auto;margin-top: 155px">
		<div class="panel panel-primary" style="box-shadow: 11px 11px 22px black">
			...
			<div class="panel-body">
				...
				<button class="btn btn-block btn-success bt-sm " id="uploadCv"><i class="pull-left fa fa-save fa-fw"></i >Upload Resume</button>
				

			</div>
			<div class="panel-footer">
				Resume will be uploaded to database for later use. 
			</div>
		</div>
	</div>
</div>
...
//for saving cv
	//dialog pr save wale btn pr click krne ke bad yeh chalega
	// this will run after clicking on the dialog box

		...
		<div class="cvBody flex pull-left" >
			<div class="cv-head">
				<div class="photo center ">
					...
					<span style="color: black;" id="cvname">Your Name</span>
				</div>
				...
				<div class="about-tab ">
					...
					<div class="about-details">
						<ul>
							<li id="cvphone1">01234567891</li>
							<li id="cvphone2" style="display: none">01234567891</li>
				...
				<div class="body-item">
					...
					<div class="body-details fontTreb">
						...
						<div class="detail-item" id="cvEdu1">
							...
							<span id="cvEdu2name">Course Or Any other Practice</span>,
					...
					<div class="body-details fontTreb" id="cvExp1">
						<div class="detail-item">
							<div class="detail-item-head" id="cvExp1">
								<span id="cvExp1name">Any Practice</span>, 
								<span id="cvExp1start">20__</span>-
								<span id="cvExp1leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp1insiti">Company Or Institute Name</div>
						</div>

						<div class="detail-item" style="display: none;" id="cvExp2">
							<div class="detail-item-head">
								<span id="cvExp2name">Course Or Any other Practice</span>, 
								<span id="cvExp2start">20__</span>-
								<span id="cvExp2leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp2insiti">Company Or Institute Name</div>
						</div>

						<div class="detail-item" style="display: none;" id="cvExp3">
							<div class="detail-item-head">
								<span id="cvExp3name">Course Or Any other Practice</span>, 
								<span id="cvExp3start">20__</span>-
								<span id="cvExp3leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp3insiti">Company Or Institute Name</div>
						</div>
						
						<div class="detail-item" style="display: none;" id="cvExp4">
							<div class="detail-item-head">
								<span id="cvExp4name">Course Or Any other Practice</span>, 
								<span id="cvExp4start">20__</span>-
								<span id="cvExp4leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp4insiti">Company Or Institute Name</div>
						</div>

						<div class="detail-item" style="display: none;" id="cvExp5">
							<div class="detail-item-head">
								<span id="cvExp5name">Course Or Any other Practice</span>, 
								<span id="cvExp5start">20__</span>-
								<span id="cvExp5leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp5insiti">Company Or Institute Name</div>
						</div>

						<div class="detail-item" style="display: none;" id="cvExp6">
							<div class="detail-item-head">
								<span id="cvExp6name">Course Or Any other Practice</span>, 
								<span id="cvExp6start">20__</span>-
								<span id="cvExp6leave">present</span>
							</div>
							<div class="detail-item-body" id="cvExp6insiti">Company Or Institute Name</div>
						</div>
					</div>
				</div>
	...
	<div class="" style="width: 366px;padding: 22px;margin: auto;margin-top: 155px">
		<div class="panel panel-primary" style="box-shadow: 11px 11px 22px black">
			...
			<div class="panel-body">
				...
				<button class="btn btn-block btn-success bt-sm " id="uploadCv"><i class="pull-left fa fa-save fa-fw"></i >Upload Resumes</button>
